...
BethAI RFQ Express — an internal tool that automates the weekly RFQ-to-approval-to-payment workflow for Admin, Sales, and Operations teams, turning hours of manual entry into a single-input, auto-generated output.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "195558562+mhike0911@users.noreply.github.com"
  git config user.name "mhike0911"
  ```
